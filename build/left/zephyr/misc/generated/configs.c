...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EC11_TRIGGER_OWN_THREAD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EC11_TRIGGER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EC11_THREAD_PRIORITY, 7);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EC11_THREAD_STACK_SIZE, 2048);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHIELD_MONA2_L, 1);
