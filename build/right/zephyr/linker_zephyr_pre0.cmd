...
zmk_rpc_custom_subsystem_area : SUBALIGN(4) { _zmk_rpc_custom_subsystem_list_start = .; KEEP(*(SORT_BY_NAME(._zmk_rpc_custom_subsystem.static.*))); _zmk_rpc_custom_subsystem_list_end = .; } > FLASH
